...
footer {
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="http://www.task4it.com/img/ui/header-logo.png">
      </div>
      {{--  <div id="company">
    ...
    <main>
      ...
      <div id="notices">
        <div>NOTICE:</div>
        <div class="notice">This report was generated at {{\Carbon\Carbon::now()->toDayDateTimeString()}}</div>
      </div>
    </main>
    <footer>
