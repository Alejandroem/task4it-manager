    ...
    <div class="col-md-8 form-group">
        <div class="row my-2">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="datetimepicker form-control date_timepicker_start" name="started_at" id="started_at">
            </div>
            <div class="form-group col-md-6">
                {{Form::label('ended_at', 'Date:')}} 
                <input class="datetimepicker form-control date_timepicker_end" name="ended_at" id="ended_at">
            </div>
        </div>
        <div class="row">
